...
In comparison, the (recently updated) [best practices](/guides/best-practicesss) reflect principles that we believe to be true for any dbt project. Of course, these two documents go hand in hand – our projects are structured in such a way that makes the those principles easy to observe, in particular:
